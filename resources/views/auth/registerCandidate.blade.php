        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('profilecreated') }}">
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="">
                                        <input id="PreferredPhone" type="text" class="form-control{{ $errors->has('PreferredPhone ') ? ' is-invalid' : '' }}" name="PreferredPhone"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="">
                                        <input id="SalaryInformation" type="text" class="form-control{{ $errors->has('SalaryInformation') ? ' is-invalid' : '' }}" name="SalaryInformation"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="">
                                        <input id="CurrentTotalMonthlyPackage" type="text" class="form-control{{ $errors->has('CurrentTotalMonthlyPackage') ? ' is-invalid' : '' }}" name="CurrentTotalMonthlyPackage"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="">
                                        <input id="ExpectedMonthlySalary" type="text" class="form-control{{ $errors->has('ExpectedMonthlySalary') ? ' is-invalid' : '' }}" name="ExpectedMonthlySalary"
